  ...
  return (
    <nav className="bg-custome-color shadow fixed w-full z-40  " >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`sm:hidden ${isMenuOpen ? 'block duration-200 opacity-100 ease-in-out h-auto' : 'opacity-0 duration-300 ease-out h-0'}`}>
...
const NavItem = ({ href, text, iconSrc }) => (
  <a
    href={href}
    className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
  >
    <img width="20" height="20" src={iconSrc} alt={text} className="mr-1" />
    {text}
  </a>
);
